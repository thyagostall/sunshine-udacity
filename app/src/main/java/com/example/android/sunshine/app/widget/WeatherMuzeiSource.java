...
public class WeatherMuzeiSource extends MuzeiArtSource {
    ...
    protected void onUpdate(int reason) {
        ...
        Uri weatherForLocactionUri = WeatherContract.WeatherEntry.buildWeatherLocationWithStartDate(location, System.currentTimeMillis());
        Cursor cursor = getContentResolver().query(weatherForLocactionUri, FORECAST_COLUMNS, null, null, WeatherContract.WeatherEntry.COLUMN_DATE + " ASC");
